...
{
	ds_put_format(s, "%smodify_field:field_id=%"PRIu16",offset=%"PRIu16",len=%"PRIu16",increment=%"PRIu32,
			a->field_id, a->offset, a->len_field, a->increment);
}
...
get_ofpact_map(enum ofp_version version)
{
    ...
    static const struct ofpact_map of10[] = {
        ...
        { OFPACT_STRIP_VLAN, 33 }, /* tsf: change 3 to 33 */
    ...
    static const struct ofpact_map of11[] = {
        ...
        { OFPACT_SET_VLAN_VID, 25 }, /* tsf: change 1 to 25 */
        { OFPACT_SET_VLAN_PCP, 2 },
        { OFPACT_SET_ETH_SRC, 33 }, /* tsf: change 3 to 33 */
